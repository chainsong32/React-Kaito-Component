...
var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "kaito-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "kaito-upload-list-item", key: item.uid },
