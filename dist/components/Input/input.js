...
var Input = function (props) {
    ...
    //根据属性计算不同的className
    var cnames = classNames('kaito-input-wrapper', (_a = {},
    ...
    React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "input-group-prepand" }, prepend),
        icon && React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon })),
        React.createElement("input", __assign({ className: "kaito-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "kaito-input-group-append" }, append)));
};
