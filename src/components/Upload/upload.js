...
var Upload = function (props) {
    ...
    return (<div className="kaito-upload-component">
      <div className="kaito-upload-input" style={{ display: 'inline-block' }} onClick={handleClick}>
          {drag ?
            <dragger_1["default"] onFile={function (files) { uploadFiles(files); }}>
              {children}
            </dragger_1["default"]> :
            children}
        <input className="kaito-file-input" style={{ display: 'none' }} ref={fileInput} onChange={handleFileChange} type="file" accept={accept} multiple={multiple}/>
      </div>

      <uploadList_1["default"] fileList={fileList} onRemove={handleRemove}/>
    </div>);
};
